/*
 * LeetCode Problem 1934: Evaluate the Bracket Pairs of a String
 * Problem Number: 1934
 * Difficulty: Medium
 ...
 *
 * 	For example, in the string "(name)is(age)yearsold", there are two bracket pairs
 * that contain the keys "name" and "age".
 *
