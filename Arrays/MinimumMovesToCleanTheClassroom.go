/*
 * LeetCode Problem 3870: Minimum Moves to Clean the Classroom
 * Problem Number: 3870
 * Difficulty: Medium
 ...
 * cleaning up litter scattered around the room. Each cell in the grid is one of
 * the following:
 *
 ...
 * If the energy reaches 0, the student can only continue if they are on a reset
 * area 'R', which resets the energy to its maximum capacity energy.
 *
 ...
 * 	A valid sequence of moves to collect all litter is as follows:
 *
 * 		Move 1: From (0, 1) &rarr; (0, 0) to collect the first litter 'L' with 1 unit
 * of energy used and 3 units remaining.
 * 		Move 2: From (0, 0) &rarr; (1, 0) to 'R' to reset and restore energy back to
 * 4.
