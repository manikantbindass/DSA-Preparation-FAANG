/*
 * LeetCode Problem 3583: Sorted GCD Pair Queries
 * Problem Number: 3583
 * Difficulty: Hard
 ...
 * pairs (nums[i], nums[j]), where 0 <= i < j < n, and then sorting these values in
 * ascending order.
 *
 ...
 * Explanation:
 *
 * gcdPairs = [gcd(nums[0], nums[1]), gcd(nums[0], nums[2]), gcd(nums[1], nums[2])]
 * = [1, 2, 1].
 *
