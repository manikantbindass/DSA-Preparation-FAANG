/*
 * LeetCode Problem 2212: Removing Minimum and Maximum From Array
 * Problem Number: 2212
 * Difficulty: Medium
 ...
 * the highest value. We call them the minimum and maximum respectively. Your goal
 * is to remove both these elements from the array.
 *
 ...
 * We can remove both the minimum and maximum by removing 2 elements from the front
 * and 3 elements from the back.
