/*
 * LeetCode Problem 3236: Smallest Missing Integer Greater Than Sequential Prefix Sum
 * Problem Number: 3236
 * Difficulty: Easy
 ...
 *
 * A prefix nums[0..i] is sequential if, for all 1 <= j <= i, nums[j] = nums[j - 1]
 * + 1. In particular, the prefix consisting only of nums[0] is sequential.
 *
 ...
 * Output: 6
 * Explanation: The longest sequential prefix of nums is [1,2,3] with a sum of 6. 6
 * is not in the array, therefore 6 is the smallest missing integer greater than or
 * equal to the sum of the longest sequential prefix.
 *
 * Example 2:
 *
