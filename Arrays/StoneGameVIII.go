/*
 * LeetCode Problem 2002: Stone Game VIII
 * Problem Number: 2002
 * Difficulty: Hard
 ...
 * of the ith stone from the left, return the score difference between Alice and
 ...
 * - Bob removes the first 2 stones, adds 2 + (-5) = -3 to his score, and places a
 * stone of value -3 on
 * the left. stones = [-3].
 ...
 * Output: 13
 * Explanation:
 * - Alice removes all stones, adds 7 + (-6) + 5 + 10 + 5 + (-2) + (-6) = 13 to her
 * score, and places a
