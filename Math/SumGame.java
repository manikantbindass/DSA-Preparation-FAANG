/*
 * LeetCode Problem 2039: Sum Game
 * Problem Number: 2039
 * Difficulty: Medium
 ...
 * equal.
 *
 * 	For example, if the game ended with num = "243801", then Bob wins because 2+4+3
 * = 8+0+1. If the game ended with num = "243803", then Alice wins because 2+4+3 !=
 * 8+0+3.
 *
